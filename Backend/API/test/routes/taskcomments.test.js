...
describe('Task Comment creation validation', () => {
  ...
  test('Test #48 - Insert a task comment without a task ID', () => testTemplate({ task_id: null }, 'Task ID is required!'));
  test('Test #49 - Insert a task comment without a user ID', () => testTemplate({ user_id: null }, 'User ID is required!'));
  test('Test #50 - Insert a task comment without a content', () => testTemplate({ content: null }, 'Content is required!'));
});
