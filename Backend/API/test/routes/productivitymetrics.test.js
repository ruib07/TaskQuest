...
test('Test #60 - Get all productivity metrics by project ID', () => app.db('productivity_metrics')
  .insert({
...
test('Test #61 - Get all productivity metrics by user ID', () => app.db('productivity_metrics')
  .insert({
    project_id: project.id,
    user_id: user.id,
    tasks_completed: 10,
