...
test('Test #54 - Get all chat messages by project ID', () => app.db('chat_messages')
  .insert({
...
test('Test #55 - Insert a new chat message', async () => {
...
describe('Chat Message creation validation', () => {
  ...
  test('Test #56 - Insert a chat message without a project ID', () => testTemplate({ project_id: null }, 'Project ID is required!'));
  test('Test #57 - Insert a chat message without a sender ID', () => testTemplate({ sender_id: null }, 'Sender ID is required!'));
  test('Test #58 - Insert a chat message withou a content', () => testTemplate({ content: null }, 'Content is required!'));
});
